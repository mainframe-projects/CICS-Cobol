      ...
      ******************************************************************
       ...
       01 WS-NUMC        PIC 9(9)  VALUE 9.
       01 WS-NUMD        PIC 9(9)  VALUE 22.
       01 WS-NUMT        PIC 9(10) VALUE 30.
       ...
       MAIN-PROCEDURE.
            ...
            SUBTRACT WS-NUMA WS-NUMB WS-NUMC FROM WS-NUMD GIVING WS-NUMT.

            DISPLAY "NUM1 + WS-NUM2 - WS-NUM3  = WS-NUM3 : " WS-NUM3
            DISPLAY "NUM4 + WS-NUM2 - WS-NUM4  = WS-NUM4 : " WS-NUM4
            DISPLAY "NUMA + NUMB + NUMC - NUMD = WS-NUMT : " WS-NUMT
            STOP RUN.
