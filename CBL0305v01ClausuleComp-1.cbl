      ...
      * Author     : ALDV
      * Date       : 28/11/2018
      * Purpose    : Representa un número flotante de precisión simple
      *              los datos se almacenan en formato hexadecimal
      *              COMP-1 no acepta la clausula PIC
      *              Una palabra es igual a 4 bytes
      ******************************************************************
       ...
       01 WS-TEN1          USAGE IS COMP-1.

       01 WS-TEA           PIC 9(5)V9(3)  VALUE 107.
       01 WS-TEA1          COMP-1.

       01 WS-INTERES       PIC 9(10)V9(3)  VALUE 2002005.
       01 WS-INTERES1      COMP-1.

       PROCEDURE DIVISION.
       MAIN-PROCEDURE.

            MOVE "COMP-1 CLAUSE" TO WS-TEMA
